...
export const chatKnowledgeBase = [
  ...
  },
  {
    ...
    a: {
      es: "No va incluido por defecto. El precio se define después de una consulta inicial, según lo que necesite tu negocio — no trabajamos con tarifas cerradas. En Órbita el mantenimiento prioritario ya está incluido.",
      en: "It's not included by default. The price is defined after an initial consultation, based on what your business needs — we don't work with fixed rates. In Órbita, priority maintenance is already included.",
      gl: "Non vai incluído por defecto. O prezo defínese despois dunha consulta inicial, segundo o que precise o teu negocio — non traballamos con tarifas pechadas. En Órbita o mantemento prioritario xa está incluído.",
    },
